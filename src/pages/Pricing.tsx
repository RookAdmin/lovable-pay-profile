  ...
  return (
    <div className="container max-w-6xl px-4 py-16 mx-auto">
      <div className="max-w-3xl mx-auto text-center mb-16">
        <h1 className="text-4xl font-bold mb-4 text-[#333333]">Pricing Plans</h1>
        ...
        <div className="flex items-center justify-center p-4 bg-blue-50 rounded-lg mb-8 max-w-xl mx-auto">
          ...
          <p className="text-blue-800">
            All features are currently free. We'll be introducing pricing plans soon, 
      ...
      <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
        ...
        <Card className="border border-gray-200 hover:shadow-lg transition-shadow duration-300">
          <CardHeader className="pb-4 text-center">
            <CardTitle className="text-2xl font-bold text-[#333333]">Free</CardTitle>
            <p className="text-4xl font-bold mt-4 text-[#333333]">$0<span className="text-lg text-[#555555] font-normal">/mo</span></p>
        ...
        <Card className="border border-primary relative hover:shadow-lg transition-shadow duration-300">
          ...
          <CardHeader className="pb-4 text-center pt-10">
            <CardTitle className="text-2xl font-bold text-[#333333]">Pro</CardTitle>
            <p className="text-4xl font-bold mt-4 text-[#333333]">$9<span className="text-lg text-[#555555] font-normal">/mo</span></p>
          ...
          <CardContent className="space-y-4">
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span className="text-[#333333]"><strong>Everything in Free</strong></span>
              </li>
              <li className="flex items-start">
                <svg className="w-5 h-5 text-green-500 mr-2 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
        ...
        <Card className="border border-gray-200 hover:shadow-lg transition-shadow duration-300">
          <CardHeader className="pb-4 text-center">
            <CardTitle className="text-2xl font-bold text-[#333333]">Enterprise</CardTitle>
          ...
          <CardContent className="space-y-4">
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span className="text-[#333333]"><strong>Everything in Pro</strong></span>
              </li>
              <li className="flex items-start">
                <svg className="w-5 h-5 text-green-500 mr-2 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
