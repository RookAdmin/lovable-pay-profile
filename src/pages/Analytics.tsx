...
const Analytics = () => {
  return (
    <>
      <Helmet>
        <title>Analytics - Rook Payment Platform</title>
        <meta name="description" content="View detailed analytics and insights for your payment links and transactions on Rook Payment Platform" />
      </Helmet>
