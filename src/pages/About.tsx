  ...
  return (
    <div className="container max-w-5xl py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="bg-muted rounded-lg p-8 text-center">
        <h2 className="text-2xl font-bold text-[#333333] mb-4">Our Vision</h2>
        <p className="text-lg text-[#555555] max-w-3xl mx-auto">
          We envision a world where creators can focus on what they do best – creating amazing content – without worrying about the complexities of payment processing and data security.
        </p>
      </div>
    </div>
  );
