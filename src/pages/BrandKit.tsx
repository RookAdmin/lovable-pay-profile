...
const BrandKit = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Brand Kit | Paym.me</title>
        <meta
          name="description"
          content="Download official Paym.me brand assets, logos, colors, and guidelines for correct brand representation."
        />
      </Helmet>
      <div className="container max-w-5xl py-12 px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto mb-6">
            Everything you need to represent the Paym.me brand correctly in your
            communications.
          </p>
          <Button
          ...
          <TabsContent value="logos" className="space-y-8">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Download official Paym.me logo assets in various formats and
                  sizes.
                </CardDescription>
              </CardHeader>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  See how to correctly display the Paym.me logo in various
                  contexts.
                </CardDescription>
              </CardHeader>
            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <p>
                    Paym.me uses Inter as its primary font family. For headings,
                    we use a font weight of 600 (semibold) or 700 (bold). For
                    body text, we use regular (400) or medium (500) weights.
                  </p>
                ...
                <div>
                  <Button
                    onClick={() => handleDownload("Complete Guidelines PDF")}
                    className="flex gap-2"
                  >
                    <Download size={16} />
