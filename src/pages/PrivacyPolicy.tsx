...
const PrivacyPolicy = () => {
  return (
    <>
      <Helmet>
        <title>Privacy Policy | Paym.me</title>
        <meta
          name="description"
          content="Read the Paym.me privacy policy to learn how we protect your data and privacy."
        />
      </Helmet>
      <div className="container max-w-4xl px-4 py-12 mx-auto">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <p>
            Welcome to Paym.me ("we," "our," or "us"). We are committed to
          ...
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li>
              Transaction data (payment amounts, dates, recipient information)
            </li>
