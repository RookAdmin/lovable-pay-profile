...
const Home = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Home | Paym.me</title>
        <meta
          name="description"
          content="Paym.me lets you collect payments privately with a single beautiful link. Create your payment profile today."
        />
      </Helmet>
        ...
        <section className="py-24 bg-gradient-to-br from-white to-white relative overflow-hidden">
          ...
          <div className="container px-4 relative z-10">
            <div className="max-w-3xl mx-auto text-center mb-16">
              ...
              <p className="text-lg md:text-xl text-black/80">
                A complete payment identity solution that puts your privacy
                first
              </p>
            </div>
