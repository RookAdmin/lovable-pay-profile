...
const TermsOfService = () => {
  return (
    <>
      <Helmet>
        <title>Terms of Service | Paym.me</title>
        <meta
          name="description"
          content="Read the Paym.me terms of service. Understand your rights and responsibilities as a user."
        />
      </Helmet>
      <div className="container max-w-4xl px-4 py-12 mx-auto">
        <h1 className="text-3xl font-bold mb-8 text-[#333333]">
          Terms of Service
        </h1>
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <h2 className="text-2xl font-bold mt-8 mb-4 text-[#333333]">
            1. Acceptance of Terms
          </h2>
          <p>
            By accessing or using Paym.me's website and services, you agree to
          ...
          <p>
            Paym.me provides a platform that allows users to create payment
            identities and receive payments through various payment methods. We
            are not a financial institution or a payment processor, but rather
            facilitate the sharing of payment information between users.
          </p>
          ...
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li>
              Upload malicious code or attempt to interfere with our services
            </li>
          ...
          <p>
            ...
            reason, including if we believe you have violated these Terms of
            Service.
          </p>
          ...
          <p>
            To the maximum extent permitted by law, Paym.me shall not be liable
